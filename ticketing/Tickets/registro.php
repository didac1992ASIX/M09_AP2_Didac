...
<body>
        ...
        <a href="../historic.php">Historial</a>
...
<div class="row">
  ...
  <div class="col-md-4">
    ...
    <div class="form-group">
        <label for="dir">Tipo:</label>
        <select name="cat" class="form-control" id="cat">
			<option value ="Hardware">Hardware</option>
      <option value ="Software">Software</option>
			<option value ="Internet">Red</option>
      <option value ="Internet">Otro</option>
		</select>
    </div>
  ...
  <?php
    ...
    if($varsesion!= "Admin"){
        ...
        echo "<br>"."Usuario no autorizado para modificar ni eliminar datos";
